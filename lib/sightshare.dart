...
class SightSharen extends StatefulWidget {
  const SightSharen({super.key});

  @override
  State<SightSharen> createState() => _ShareState();
}

class _ShareState extends State<SightSharen> {
