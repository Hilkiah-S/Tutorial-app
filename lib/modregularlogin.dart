...
import 'package:tutorialapp/startpageregular.dart';
 ...
 class Regregular extends StatefulWidget {
  const Regregular({super.key});

  @override
  State<Regregular> createState() => _RegsightState();
}

class _RegsightState extends State<Regregular> {
